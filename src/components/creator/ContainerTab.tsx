            ...
            {mediaItems.some(i => i.source === 'ai_auto') && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button onClick={() => scroll(aiScrollRef, 'left')} className="p-2 rounded-full glass-card border-white/10 hover:bg-white/10 transition-colors">
                      <ChevronLeft size={16} />
                    </button>
                    <button onClick={() => scroll(aiScrollRef, 'right')} className="p-2 rounded-full glass-card border-white/10 hover:bg-white/10 transition-colors">
                      <ChevronRight size={16} />
                    </button>
                  </div>
                </div>
                ...
                >
                    ...
                    <div key={item.id} className="relative aspect-square rounded-2xl overflow-hidden cursor-pointer group bg-black/50 border border-primary/20 snap-start">
